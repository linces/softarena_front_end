...
uses
  ...
  unFrameMenu,
  System.ImageList, Vcl.ImgList, uniEdit, uniGroupBox, uniPageControl, UniSFHold;
...
uses
  uniGUIVars, MainModule, uniGUIApplication, unCadastroInicial, unTipoPessoas, unCadPadrao,
  uButton;
