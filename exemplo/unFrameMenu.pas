...
uses
  Main, unCadastroInicial, unTipoPessoas;
...
begin
  MainForm.CriaForm3(frmCadastroInicial, 'Cadastro Inicial', 'abaEmpresa');
end;

procedure TfrmFrameMenu.UniButton3Click(Sender: TObject);
begin
   MainForm.CriaForm3(frmTipoPessoas, 'Tipo Pessoas', 'abaTipoPessoa');
end;
